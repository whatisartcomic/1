  ...
  fetch('haikus.json')
    ...
    .then(data => {
      ...
      const initFlipbook = (w, h) => {
        ...
        // b) Initialize Turn.js with cornerSize:0 to disable corner drags/taps
        $fb.turn({
          width:        w,
          height:       h,
          display:      'single',
        ...
        // c) Refresh wrappers before interactions
        $fb.turn('refresh');

        // d) Disable any residual corner-click/tap handlers
        (function(){
